...
missingkey = [i for i in list(translation.values()) if i not in list(translation.keys())][0]
missingvalue = [i for i in list(translation.keys()) if i not in list(translation.values())][0]
