...
def solve_problem(output_writer=sys.stdout, **kwargs):
    ...
    print("Case #%d:" % case, file=output_writer)
    row_string = "{:*<%ds}" % cols
    impossible = False
    if safe_squares == 1:
        print(row_string.format("c"), file=output_writer)
        for row in range(1, rows):
            print(row_string.format(""), file=output_writer)
    elif rows == 1:
        safe_string = "c" + ("." * (safe_squares - 1))
        print(row_string.format(safe_string), file=output_writer)
    elif cols == 1:
        for row in range(rows):
            ...
            if row == 0:
                ...
                cell = "."
            print(row_string.format(cell), file=output_writer)
    elif safe_squares == 2:
        impossible = True
    elif rows == 2:
        ...
        if remainder == 1:
            ...
            print(row_string.format("c%s" % safe_string), file=output_writer)
            print(row_string.format(".%s" % safe_string), file=output_writer)
    elif cols == 2:
        ...
        if remainder == 1:
            ...
            for row in range(rows):
                ...
                if row == 0:
                    ...
                    cells = ".."
                print(row_string.format(cells), file=output_writer)
    else:
        ...
        if remainder == 1 and cols == 3 and safe_rows == 2:
            ...
            if remainder == 1 and safe_rows == 2:
                ...
                for row in range(rows):
                    ...
                    if safe_rows < 3:
                        last_cell = ""
                    print(row_string.format("%s%s%s" % (cell_one, mid_cells, last_cell)), file=output_writer)
                    safe_rows -= 1
            elif remainder == 1:
                mid_safe = "." * (cols-2)
                for row in range(rows):
            ...
            if remainder == 1 and safe_cols < 4:
                ...
                print(row_string.format("c%s" % ("." * (safe_cols - 1))), file=output_writer)
                print(row_string.format("." * safe_cols), file=output_writer)
                ...
                for row in range(3, rows):
                    print(row_string.format(""), file=output_writer)
    if impossible:
        print(IMPOSSIBLE, file=output_writer)
